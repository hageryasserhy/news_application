...
import 'news_tec_state.dart';


class NewstecCubit extends Cubit<NewstecState> {
  NewstecCubit() : super(NewstecInitial());
  static NewstecCubit get(context)=>BlocProvider.of(context);
